...
export default function PaymentUnfinishPage({ searchParams }: PaymentResultPageProps) {
    ...
    <main className="app-page">
      <section className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-300/70 dark:border-slate-700 dark:bg-slate-900/80">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-700">Payment Result</p>
          <h1 className="mt-2 text-3xl font-bold text-slate-900 dark:text-slate-100">Pembayaran Belum Selesai</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
            User kembali dari halaman Midtrans sebelum transaksi selesai.
          </p>
